...
const Freq = () => {
  ...
  return (
    <div className="bg-gray-100 pb-10"> 
        ...
        <div className=" container mx-auto max-w-2xl border-b-2 border-gray-200 py-2">
            <div className="flex justify-between"  onClick={()=> setIsOpen(!isOpen)}>
                <h1 className="font-semibold">Who can apply?</h1>
                {isOpen ?  <FaCircleMinus color="green" size={20}/> : <IoAddCircle color="green" size={20}/> }
            </div>
            {
                isOpen && <div className="mt-5 text-gray-400">
